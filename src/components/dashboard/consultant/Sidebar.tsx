...
export const Sidebar = () => {
    ...
    return (
        <motion.aside
            ...
            className="min-h-screen h-full bg-white border-r border-slate-200/80 fixed left-0 top-0 bottom-0 z-40 flex flex-col shadow-xl shadow-slate-200/50 overflow-hidden"
        >
            ...
            <div className={`p-6 flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} border-b border-slate-100`}>
