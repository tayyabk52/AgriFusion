    ...
    <div className="border-b border-slate-200">
      <div className="flex gap-1">
        ...
        >
          <motion.div
            whileHover={{ y: -2 }}
            className={`px-3 md:px-6 py-2 md:py-3 rounded-t-xl transition-all cursor-pointer ${isLinkActive
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm">Link Existing Farmer</span>
            </div>
          </motion.div>
        </button>
        ...
        >
          <motion.div
            whileHover={{ y: -2 }}
            className={`px-3 md:px-6 py-2 md:py-3 rounded-t-xl transition-all cursor-pointer ${isCreateActive
                ? 'bg-white border-t-2 border-x border-emerald-600 text-emerald-700 font-semibold -mb-[1px]'
                : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'
              }`}
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs md:text-sm">Create New Account</span>
            </div>
          </motion.div>
        </button>
      </div>
