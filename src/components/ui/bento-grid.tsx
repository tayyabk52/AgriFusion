...
const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid w-full auto-rows-[22rem] grid-cols-1 lg:grid-cols-3 gap-6",
        className
      )}
    >
      {children}
...
const BentoCard = ({
    ...
    >
      ...
      <div className="relative h-52 overflow-hidden bg-slate-900">
        ...
        <motion.div
          ...
          whileHover={{
            background:
              "linear-gradient(to top, rgb(2, 6, 23), rgba(15, 23, 42, 0.7), rgba(15, 23, 42, 0.4))",
          }}
  ...
  if (href) {
    return (
      <Link href={href as string} className="block col-span-3 lg:col-span-1">
        {cardContent}
      </Link>
    );
  }
