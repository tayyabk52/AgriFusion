...
import { GraduationCap, Star, MessageCircle, Phone, Mail, MapPin } from 'lucide-react';
import { motion } from 'framer-motion';

const EXPERTS_DATA = [
    { id: 1, name: 'Dr. Ahmed Hassan', specialty: 'Soil Science', rating: 4.9, consultations: 156, status: 'available', phone: '+92 300 1234567', email: 'ahmed@agri.pk', location: 'Faisalabad', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&q=80' },
    { id: 2, name: 'Dr. Sara Khan', specialty: 'Pest Management', rating: 4.8, consultations: 142, status: 'busy', phone: '+92 301 2345678', email: 'sara@agri.pk', location: 'Lahore', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80' },
    { id: 3, name: 'Dr. Usman Ali', specialty: 'Irrigation Expert', rating: 4.7, consultations: 128, status: 'available', phone: '+92 302 3456789', email: 'usman@agri.pk', location: 'Multan', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80' },
    { id: 4, name: 'Dr. Zainab Malik', specialty: 'Crop Pathology', rating: 4.9, consultations: 178, status: 'available', phone: '+92 303 4567890', email: 'zainab@agri.pk', location: 'Sialkot', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=100&q=80' },
];
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-slate-500">Connect with agricultural experts for specialized consultations</p>
                        </div>
                    </div>
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex items-start gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-emerald-600 font-semibold mb-2">{expert.specialty}</p>
                                        ...
                                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                                            ...
                                            <span className={`inline-block w-1.5 h-1.5 rounded-full mr-1.5 ${
                                                expert.status === 'available' ? 'bg-emerald-500' : 'bg-amber-500'
                                            }`} />
