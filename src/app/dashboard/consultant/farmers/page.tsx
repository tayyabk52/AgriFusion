...
export default function FarmersPage() {
  ...
  const [consultantProfileId, setConsultantProfileId] = useState<string | null>(
    null
  );
  ...
  const [farmerToRemove, setFarmerToRemove] =
    useState<FarmerWithProfile | null>(null);
  ...
  const handleRemoveConfirm = async () => {
    ...
    try {
      ...
      setMessage({
        type: "success",
        text: "Farmer removed from your network.",
      });
      refreshFarmersList();
